...
urlpatterns = [
    path('<int:activity_id>/overiew', views.FeedbackOverview.as_view(), name='feedback_overview'),
    ...
    path('<int:activity_id>/feedback-questions', views.FeedbackSubmission.as_view(),
