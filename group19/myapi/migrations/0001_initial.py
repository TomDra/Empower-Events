# Generated by Django 4.2.8 on 2024-03-18 04:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_text', models.CharField(blank=True, max_length=500, null=True)),
                ('feedback_audio', models.BinaryField(blank=True, null=True)),
                ('feedback_question_answers', models.TextField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapi.activityleader'),
        ),
        migrations.AddField(
